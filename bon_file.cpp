                    ...
                    , int min_size, int num_directories, bool do_random)
{
  ...
  timer.add_latency(do_random ? CreateRand : CreateSeq, dur.getMean());
  return 0;
}
...
int COpenTest::delete_random(BonTimer &timer)
{
  ...
  timer.add_latency(DelRand, dur.getMean());
  return 0;
}
...
int COpenTest::delete_sequential(BonTimer &timer)
{
  ...
  timer.add_latency(DelSeq, dur.getMean());
  return 0;
}
...
int COpenTest::stat_random(BonTimer &timer)
{
  ...
  timer.add_latency(StatRand, dur.getMean());
  return 0;
}
...
int COpenTest::stat_sequential(BonTimer &timer)
{
  ...
  timer.add_latency(StatSeq, dur.getMean());
  return 0;
}
